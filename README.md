...
>you must install all the necessary requirements and installation related files in advance. In particular, 
>there are three key files that must be installed to run bashNmap, 
