<img src="https://capsule-render.vercel.app/api?type=wave&color=auto&height=300&section=header&text=bash%20Nmap&fontSize=90" />
...
In particular, there are three key files that must be installed to run bashNmap, so please check them before installing.
<br>
* requirements.txt
* req.txt
* install.sh
